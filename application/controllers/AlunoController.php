                ...
                if($idaluno)
                {
                    ...
                    if($enderecoDao->insert($dataEnd))
                    {
                        ...
                        if($turma != "")
                        {
                            ...
                            $curso = $turmaDao->buscarPorId($dataTurma['turma_idturma']);
                            $contatosDao = new Application_Model_Contatos();
                            $listaContatoSite = $contatosDao->listarPorEmail($email, $curso["curso_idcurso"]);
                            if(count($listaContatoSite) > 0):
                                $interesseDao = new Application_Model_Interesses();
                                foreach ($listaContatoSite as $contatoSite):
                                    $interesseDao->update(array('status' => 1), "curso_idcurso = " . $curso["curso_idcurso"]
                                            . " and contatosite_idcontatosite = " . $contatoSite["idcontatosite"]);
                                endforeach;
                            endif;
                        }
            ...
            switch ($listaAluno["formapagamento"])
            {
                ...
                case 'CARTÃO E BOLETO' :
                    ...
                    $contrato .= "
                        ...
                        <p><b>§	2º - Até 30 (trinta) dias após o vencimento, os pagamentos poderão ser feitos somente nas agências do Banco ITAÚ, com os acréscimos previstos no boleto, Multa de 10%, mais juros de 2% ao mês.</b></p>

                        <p><b>§ 3º - Ultrapassados 30 (trinta) dias do vencimento, os pagamentos somente poderão ser feitos solicitando um novo boleto no site do itaú. O Título segue para protesto em 30 dias apos o vencimento e é encaminhado para negativação do cliente em 60 dias após o vencimento.</b></p>
						...
						<p><b>Cláusula 7ª </b>- As mudanças de horários ou dias da semana, dentro de uma mesma programação ou em programações diversas, será realizada desde que haja disponibilidade de vagas no turno solicitado, mediante as seguintes condições:</p>


						<p>§ 1º - Com até 7 dias de antecedência à data de início da programação ou do módulo que compõe a mesma, a transferência será feita sem ônus para o Cliente.</p>

						<p>§ 2º - Nos demais casos a transferência estará sujeita a avaliação da COTI INFORMATICA, bem como ao pagamento de taxa de transferência (se pertinente) cujo valor encontra-se na mesma.</p>

						<p>§ 3º - Para efetuar a transferência, o Cliente deverá manifestar sua intenção por e-mail para o contato@cotiinformatica.com.br e realizar o pagamento da taxa na Secretaria da COTI INFORMATICA.</p>

						<p><b>Cláusula 8ª </b>– Quaisquer declarações, atestados, certificados ou segunda via de documentos, serão cobrados no ato de sua solicitação.</p>

						<p>§ Único - As tabelas de preço de serviços, produtos e taxas estão à disposição para consulta na COTI INFORMATICA, em seu quadro de aviso.</p>

						<p><b>Cláusula 9ª </b>- O limite legal de faltas é de no máximo 25% (vinte e cinco por cento) da duração da programação, salvo os casos previstos no Decreto Lei 1044/69, Lei Federal 6202/75, Lei Federal 4375/64 e parecer CFE nº 47/76 (por exemplo, gestantes, serviço militar, doenças infecto-contagiosas). De acordo com a legislação relacionada anteriormente, as faltas serão justificadas para fins de aprovação, mas não existem reposições.</p>

						<p><b>Cláusula 10º </b>- Regras para refazer o curso: A Coti Informática entende que o aluno que já pagou por um curso não deve pagar novamente caso queira refazê-lo no período de 12 meses após ao início da turma que está vigorando nesse contrato. Portando em qualquer um de nossos cursos o aluno tem o direito de se re-matricular para reforçar o que foi aprendido. A Coti Informática disponibiliza o mínimo de 2 computadores por turma para alunos que queiram refazer o curso. Para usufruir desse benefício o aluno deve:</p>

						<p>§ 1º - O aluno deve estar adimplente com a instituição. A inadimplência o impede de usufruir do benefício. </p>

						<p>§ 2º - A solicitação para refazer deverá ser feita somente através do e-mail contato@cotiinformatica.com.br</p>

						<p>§ 3º - O aluno só poderá se re-matricular no mesmo curso que já fez.</p>

						<p>§ 4º - O aluno deverá ter no mínimo 85% de presença em sua primeira matrícula.</p>

						<p>§ 5º  O aluno quando reservar a vaga na turma parar refazer não poderá faltar a primeira aula, a ausência implica na perda do direito ao benefício de refazer o curso.</p>

						<p>§ 6º  Esse beneficio não é válido para contratos empresarias, treinamento In Company e nem para contratação de cursos personalizados, seja individuais ou corporativo.</p>

						<p><b>Cláusula 11ª </b>- Para obter a certificação ao final da programação, o Cliente deverá ter participado de no mínimo 75% (setenta e cinco por cento) das atividades propostas e ter sido aprovado por processo de avaliação.</p>

						<p>§ 1º  - Opção 1 – CERTIFICADO DIGITAL – GRATUITO, e deve ser solicitado ao termino do curso através do email contato@cotiinformatica.com.br ;   </p>

						<p>§ 1º  - OPÇÃO 2  - CERTIFICADO IMPRESSO - deve ser solicitado ao termino do curso através do email contato@cotiinformatica.com.br. Para esse é cobrado uma taxa para emissão do CERTIFICADO IMPRESSO, o valor da mesma encontra-se no quadro de aviso na secretaria da COTI;   </p>

						<p><b>Cláusula 12ª </b>- O presente contrato vigorará pelo tempo de duração da programação, constituindo motivos para sua rescisão:</p>

						<p>§ 1º - Superveniência de caso fortuito ou força maior, nos termos da legislação civil; e</p>

						<p>§ 2º - Inadimplência do Cliente.</p>

						<p><b>Cláusula 13ª </b>- Qualquer reclamação que o Cliente queira apresentar a COTI INFORMATICA, relacionada à atividade, objeto deste contrato, só será aceita se formulada por escrito, mediante correspondência firmada pelo Cliente e protocolada junto à COTI INFORMATICA onde a atividade tenha sido ou estiver sendo prestada.</p>

						<p><b>Cláusula 14ª </b>- Fica eleito o Foro da Comarca da Capital do Estado do Rio de Janeiro, para a solução de dúvidas ou litígios porventura decorrentes deste contrato, com expressa renúncia de qualquer outro, por mais privilegiado que seja.</p>

						<p>E, por estarem as partes justas e contratadas, assinam o presente em duas vias, de igual teor, na presença das testemunhas abaixo nomeadas</p>
...
";
   ...
   public function devedorAction(){
		$idaluno = $this->getRequest()->getParam("id", 0);
		$vldevedor = $this->getRequest()->getParam("params", 0);
		
		if($vldevedor == 0) $value = 1;
		else $value = 0;
		
		$alunoDao = new Application_Model_Alunos();
        $aluno = $alunoDao->buscarId($idaluno);
        ...
        else
        {
			...
			$alunoDao->update(array('devedor' => $value), "idaluno = " . $idaluno);
			
            $this->view->resp = "Aluno alterado com sucesso!";
            //$this->indexAction();
            //$this->render('index');
            $this->_forward('index', 'Aluno');
        }
